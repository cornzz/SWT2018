...
public class CompoundFlowerShopProductCatalogInitializer implements DataInitializer {
	...
	public void initialize() {
		...
		compoundFlowerShopProductCatalog.save(new CompoundFlowerShopProduct("RGB", "Very nice bouquet!", flowerShopItems, flowerShopServices));
		compoundFlowerShopProductCatalog.save(new CompoundFlowerShopProduct("RBG", "Very nice bouquet!", flowerShopItems, flowerShopServices));
		compoundFlowerShopProductCatalog.save(new CompoundFlowerShopProduct("BRG", "Very nice bouquet!", flowerShopItems, flowerShopServices));
	}
}
