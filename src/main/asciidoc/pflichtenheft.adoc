...
a|Angebot
a|Alle Produkte, die die Auftraggeberin im Blumengeschäft verkauft.

a|Beratungsgespräch
a|Gespräch der Auftraggeberin mit einem Laufkunden im Blumengeschäft, bei welchem die Details und Wünsche des Kunden für eine Bestäellung besprochen werden.
