...
|===
|ID                   |<<1>>
|Anwendungsfall       |Shop-Register
|Vorbedingungen      a|Ein UnregisteredUser benutzt das System. Der System kennt keinen RegisteredUser mit der Name 'hans'.
|Event               a|Ein UnregisteredUser greift in login screen zu, erfüllt Tabelle mit folgenden Daten:
...
|===
|ID                   |<<3>>
|Anwendungsfall       |Shop-Login/Logout
...
|===
|ID                   |<<6>>
|Anwendungsfall       |Shop-View all Users
|Vorbedingungen      a|Ein Employee benutzt das System.
|Event               a|Der User (Employee) klickt 'Userliste'-Button.
|Erwartetes Ergebnis a|Der User (Employee) kann Liste von allen RegisteredUser sehen.
|===

[cols="1h, 4"]
|===
|ID                   |<<7>>
|Anwendungsfall       |Catalog-View Catalog
|Vorbedingungen      a|Ein User benutzt das System.
|Event               a|Der User klickt 'Katalog'-Button in Navigation Bar.
|Erwartetes Ergebnis a|Der User befindet sich in catalog screnn und kann Liste von allen bestellbaren Produkten sehen.
|===

[cols="1h, 4"]
|===
|ID                   |<<8>>
|Anwendungsfall       |Catalog-View Product Details
|Vorbedingungen      a|Ein User benutzt das System.
|Event               a|Der User befindet sich in catalog screnn und klickt auf einen Produkt in dem Katalog.
|Erwartetes Ergebnis a|Der User kann sehen Details über diesen Produkt.
|===

[cols="1h, 4"]
|===
|ID                   |<<9>>
|Anwendungsfall       |Cart-View Cart
|Vorbedingungen      a|Ein RegisteredUser benutzt das System.
|Event               a|Der User klickt auf 'Sehe Bestellung'-Knopf.
|Erwartetes Ergebnis a|Der User kann seine (noch nicht bestellte) Bestellung anschauen.
|===

[cols="1h, 4"]
|===
|ID                   |<<10>>
|Anwendungsfall       |Cart-Buy Products in Cart
|Vorbedingungen      a|Ein RegisteredUser benutzt das System.
|Event               a|Der User befindet sich in 'cart screen' und klickt 'Einkaufen'-Knopf
|Erwartetes Ergebnis a|Der User hat die Möglichkeit seine Waren zu kaufen.
|===

[cols="1h, 4"]
|===
|ID                   |<<11>>
|Anwendungsfall       |Cart-Add to Cart
|Vorbedingungen      a|Ein RegisteredUser benutzt das System.
|Event               a|Der User befindet sich in 'product detail screen' und klickt 'Addiere zu Bestellung'-Knopf
|Erwartetes Ergebnis a|Der Produkt ist addiert zu Bestellung.
|===
...
|Erwartetes Ergebnis a|Der User kann den Kalender mit publischen Terminen sehen.
|===
...
|===
|ID                   |<<16>>
|Anwendungsfall       |Inventory-Edit Inventory.
|Vorbedingungen      a|
|Event               a|
|Erwartetes Ergebnis a|
|===
...
|===
|ID                   |<<17>>
|Anwendungsfall       |Inventory-Process a Local Order.
|Vorbedingungen      a|
|Event               a|
|Erwartetes Ergebnis a|
|===
...
|===
|ID                   |<<18>>
|Anwendungsfall       |Inventory-Add new Product Combination.
|Vorbedingungen      a|
|Event               a|
|Erwartetes Ergebnis a|
|===
...
|===
|ID                   |<<20>>
|Anwendungsfall       |Inventory-Add New Item.
|Vorbedingungen      a|
|Event               a|
|Erwartetes Ergebnis a|
|===
...
|===
|ID                   |<<21>>
|Anwendungsfall       |TraderOrder-Process Open Orders
|Vorbedingungen      a|
|Event               a|
|Erwartetes Ergebnis a|
|===
...
|===
|ID                   |<<22>>
|Anwendungsfall       |Transactions-View all Orders
|Vorbedingungen      a|
|Event               a|
|Erwartetes Ergebnis a|
|===
