...
image::TopLevel.png[TopLevel, 100%, 100%, pdfwidth=100%, title= "TopLevel", align=center]
...
image::UseCase.png[Use Case diagram, 100%, 100%, pdfwidth=100%, title= "Use Case Diagram", align=center]
...
image::Add to Cart.png[Add to Cart, 100%, 100%, pdfwidth=100%, title= "Add to Cart", align=center]
...
image::Buy Items in Cart.png[Buy Items in Cart, 100%, 100%, pdfwidth=100%, title= "Buy Items in Cart", align=center]
...
image::Add new Product Combination.png[Add new Product Combination, 100%, 100%, pdfwidth=100%, title= "Add new Product Combination", align=center]
...
image::Edit Inventory.png[Edit Inventory, 100%, 100%, pdfwidth=100%, title= "Edit Inventory", align=center]
...
image::01_user_storefront.png[Startseite Online Shop, 100%, 100%, pdfwidth=100%, title= "Startseite Online Shop", align=center]
...
image::02_user_register_login.png[Registrierung (Login analog), 100%, 100%, pdfwidth=100%, title= "Registrierung (Login analog)", align=center]
...
image::03_user_shopping_cart.png[Warenkorb, 100%, 100%, pdfwidth=100%, title= "Warenkorb", align=center]
...
image::04_user_checkout.png[Bezahlen, 100%, 100%, pdfwidth=100%, title= "Bezahlen", align=center]
...
image::05_admin_products_items_services.png[Inventar, 100%, 100%, pdfwidth=100%, title= "Inventar", align=center]
...
image::06_admin_daily_invoice.png[Abrechnung, 100%, 100%, pdfwidth=100%, title= "Abrechnung", align=center]
...
image::07_in_store_purchases.png[Ladeneinkäufe, 100%, 100%, pdfwidth=100%, title= "Ladeneinkäufe", align=center]
...
image::08_calendar.png[Kalender, 100%, 100%, pdfwidth=100%, title= "Kalender", align=center]
...
image::09_outgoing_orders.png[Großhändler, 100%, 100%, pdfwidth=100%, title= "Großhändler", align=center]
...
image::Demo.png[Demo, 100%, 100%, pdfwidth=100%, title= "Demo", align=center]
...
image::Blumenladen.jpg[UML-Analyseklassendiagramm, 100%, 100%, pdfwidth=100%, title= "UML-Analyseklassendiagramm", align=center]
