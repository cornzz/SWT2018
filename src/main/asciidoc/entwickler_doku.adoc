...
image::Package.png[Packagediagramm, 100%, 100%, pdfwidth=100%, title= "Packagedigramm", align=center]

== Entwurfsentscheidungen

image::uml_catalog.jpg[Catalog, 100%, 100%, pdfwidth=100%, title= "Catalog", align=center]

image::Inventory.jpg[Inventory, 100%, 100%, pdfwidth=100%, title= "Inventory", align=center]

image::class__order.jpg[Order, 100%, 100%, pdfwidth=100%, title= "Order", align=center]

image::uml_user.jpg[Order, 100%, 100%, pdfwidth=100%, title= "User", align=center]
