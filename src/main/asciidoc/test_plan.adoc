...
|21
|Rechnungen einsehen
|Der Benutzer muss zuvor eine Bestellung getätigt haben
...
|Es wird auf die Seite "Rechnungen" weitergeleitet, die Rechnungen des Benutzers werden dem Model beigefügt
